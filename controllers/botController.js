...
<b>WB Рулетка</b> — это шанс получить одну из тысячи бесплатных купонов для вас и ваших друзей каждый день! Мы гарантируем честную статистику выпадения призов, и каждый участник обязательно выиграет. 🚀 
• Вращений колеса: <b>${user.spins || 0}</b>

📢 <b>Не упустите шанс:</b>
...
🔥 Подарочные купоны ждут вас — начните прямо сейчас и станьте одним из победителей! Удачи! 🍀
`;
...
Чтобы получить **3 бесплатных прокрута колеса** в нашей Telegram-рулетке по WB, выполните всего два простых шага:

1. Подпишитесь на наш новостной канал, чтобы быть в курсе всех обновлений.
2. Нажмите «Продолжить».

Это необходимо для защиты от ботов. Приятной игры!
`;
