...
const sendSubscriptionPrompt = async (bot, chatId, user) => {
  ...
  Получите <b>3 БЕСПЛАТНЫХ ПРОКРУТА КОЛЕСА</b> прямо сейчас! Это ваш шанс выиграть отличные подарочные купоны на покупки.
  ...
  🎁 Не упустите свой шанс — начните выигрывать уже сегодня! 🚀
  `;
